...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"u863bf51acb17640667bd9586a978e9e0"]
admin=["u863bf51acb17640667bd9586a978e9e0"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Sini dong","Kuy join","Ayo masuk","melbuo"]:
              if msg.from_ in admin:
...
#-----------------------------------------------
                ...
                kk.sendText(msg.to,"Jangan Ricuuh!")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                kc.sendText(msg.to,"Bot4 Respon")
                ks.sendText(msg.to,"Bot5 Respon")
                ka.sendText(msg.to,"Bot6 Respon")
                kb.sendText(msg.to,"Bot7 Respon")
                ko.sendText(msg.to,"Bot8 Respon")
                ke.sendText(msg.to,"Bot9 Respon")
                ku.sendText(msg.to,"Bot10 Respon , Respon Complete")
